...
// Inline Google SVG to avoid external image deps
function GoogleIcon() {
  return (
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-[#0F172A] via-[#0d2347] to-[#1e3a6e] flex-col justify-between p-12">
        ...
        <div>
          <h2 className="text-4xl font-bold text-white leading-snug mb-4">
            The aircraft market,<br />
            <span className="text-[#3B82F6]">finally modern.</span>
          </h2>
          <p className="text-slate-300 text-lg leading-relaxed max-w-sm">
            Browse 2,500+ pre-owned aircraft from verified dealers across Latin
            America and beyond.
          </p>
        </div>
        ...
        <div className="flex gap-10">
          {[
            { value: "2,500+", label: "Aircraft listed" },
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center bg-white px-6 py-12">
        <div className="w-full max-w-md">
          ...
          <p className="text-[#64748B] text-sm mb-8">
            Sign in to your AeroDesk account
          </p>
